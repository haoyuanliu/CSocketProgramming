...
void *threadSend(void *fd)
{
    ...
    {
        sendto(sockSend, sendbuf, sizeof sendbuf, 0, (struct sockaddr *)&addrSend, sizeof addrSend);
        bzero(sendbuf, sizeof sendbuf);
    }
    exit(0);
    free(fd);
